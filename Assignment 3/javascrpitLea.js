//1. creating the table
    ...
    //POST request
    const fetchStateData = async(url,body)=>{
...
const setupTable = (populationData, employmentData, percentEmploymentData) => {
    ...
    //const percentEmploymentValues = percentEmploymentData.value;
...
const initializeCode = async() => {
    ...
    const populationData = await fetchStateData(populationUrl, populationBody);
    const employmentData = await fetchStateData(employmentUrl,employmentBody);
